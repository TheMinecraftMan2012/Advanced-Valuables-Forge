package net.theminecraftman.advancedvaluables.AV_DataGen.loot;
...
public class AdvancedValuables_BlockLootTableProvider extends BlockLootSubProvider
{
    ...
    {
        return AdvancedValuables_BlockClass.BLOCKS.getEntries().stream().map(RegistryObject::get)::iterator;
    }
}
