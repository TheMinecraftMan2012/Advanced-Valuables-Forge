...
public class AdvancedValuables_BlockTagsProvider extends BlockTagsProvider
{
    public AdvancedValuables_BlockTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, @Nullable ExistingFileHelper existingFileHelper)
    {
