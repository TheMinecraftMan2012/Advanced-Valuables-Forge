...
public class AdvancedValuables_BiomeModifiers
{
    ...
    {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, ResourceLocation.fromNamespaceAndPath(AdvancedValuables.MOD_ID, name));
    }
}
